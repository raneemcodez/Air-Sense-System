...
class OfficeRoom extends StatelessWidget {
  const OfficeRoom({super.key});
      ...
      bottomNavigationBar: Obx(
        () => BottomNavigationBar(
          ...
          onTap: (index) {
            ...
            if (index == 0) {
              Get.toNamed(AppRoute.home); // غيّر هذا حسب مسار صفحتك الرئيسية
            } else if (index == 1) {
              Get.toNamed(
                AppRoute.settings,
              ); // غيّر هذا حسب مسار صفحة الإعدادات
            }
          },
          items: const [
